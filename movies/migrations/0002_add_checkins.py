...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('movies_checkin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('screening', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['movies.Screening'])),
        ))
        db.send_create_signal('movies', ['Checkin'])

        # Adding unique constraint on 'Checkin', fields ['user', 'screening']
        db.create_unique('movies_checkin', ['user_id', 'screening_id'])


    def backwards(self, orm):
        db.delete_unique('movies_checkin', ['user_id', 'screening_id'])
        db.delete_table('movies_checkin')
