...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.add_column('movies_movie', 'collection',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['movies.Movie'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        db.delete_column('movies_movie', 'collection_id')
